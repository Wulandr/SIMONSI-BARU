                    ...
                    <div class="col-12 col-sm-12">
                        <div class="card">
                            <ul class="nav nav-pills nav-fill" id="pills-tab-1" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" style="padding: 0.8rem 0rem 0.8rem 0.2rem;" href="{{url('/kelompok_mak')}}" aria-selected="true">Kelompok MAK</a>
                                </li>
                                <li class="nav-item">
                            ...
                            <div class="card-header">
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        <h5 class="main-content-label mb-1">Kelompok MAK
                                        </h5>
                                        @can('kelompokmak_create')
                                        <button class="search-toggle iq-waves-effect bg-primary rounded" data-bs-toggle="modal" title="Tambah MAK" data-original-title="Tambah MAK" data-bs-target="#tambahKelMak"><i class="fa fa-plus-circle"></i>
                                        </button>
                                        @endcan
                                        <!-- Modal Tambah KELOMPOK MAK -->
                                                ...
                                                <table class="table table-bordered text-nowrap border-bottom dataTable no-footer" id="basic-datatable" role="grid" aria-describedby="basic-datatable_info">
                                                    <thead>
                                                        <tr role="row">
                                                            ...
                                                            <th class="wd-20p sorting" tabindex="0" aria-controls="basic-datatable" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="width: 114.703px;">Nama Kelompok MAK</th>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="flex align-items-center list-user-action">
                                                                        ...
                                                                        <a class="iq-bg-primary" data-bs-toggle="modal" data-placement="top" title="Update MAK" data-original-title="Update MAK" href="" data-bs-target="#update_kel<?= $kelompok_mak[$k2]->id ?>"><i class="ri-pencil-line"></i></a>
                                                                        @endcan
                                                                        @can('kelompokmak_delete')
                                                                        <a class="iq-bg-primary kelompokmak-confirm" data-bs-toggle="tooltip" data-placement="top" title="" data-original-title="Delete" href="{{url('/kelompok_mak/delete/'.base64_encode($kelompok_mak[$k2]->id))}}"><i class="ri-delete-bin-line"></i></a>
                                                                        @endcan
                                                                    </div>
                                                                </td>
                                                            </tr>
